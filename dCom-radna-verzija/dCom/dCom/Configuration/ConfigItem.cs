...
namespace dCom.Configuration
{
    internal class ConfigItem : IConfigItem
    {
        ...
        private byte unitAddress; // Added to satisfy IConfigItem.UnitAddress
        ...
        // Implemented to satisfy IConfigItem
        ...
        public ConfigItem(List<string> configurationParameters)
        {
            ...
            // If configuration contains a unit address at position 17, parse it; otherwise leave default (0).
            if (configurationParameters.Count > 17)
            {
                byte parsedUnit;
                if (byte.TryParse(configurationParameters[17], out parsedUnit))
                {
                    unitAddress = parsedUnit;
                }
            }
        }
        ...
        // Implement the interface method. Adjust logic to return an actual transaction id when available.
        public ushort getTransactionId()
        {
            // Default implementation returning 0. Replace with real logic if transaction id is tracked elsewhere.
            return 0;
        }
    }
}